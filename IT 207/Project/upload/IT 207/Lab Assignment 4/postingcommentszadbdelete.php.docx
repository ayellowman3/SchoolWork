...
<div id="container">
	...
	$all = mysqli_query($connection, "SELECT * FROM COMMENTS ORDER BY NAME DESC;");
	$commentsarray = [];
	...
	$deletename = $commentsarray[$deletenum -1][0];
	mysqli_query($connection, "DELETE FROM COMMENTS WHERE NAME = \"$deletename\";");

	foreach($commentsarray as $comment){
		if($comment[0] != $deletename){
			echo "<div id=box>";
	...
	<div id="content2">
		...
		<form method="post" action="postingcommentszadbdelete.php">
