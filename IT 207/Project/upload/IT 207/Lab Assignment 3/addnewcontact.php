...
<?php
	if($errormessage==""){
		...
		if(flock($Handle, LOCK_EX)){
			if(fwrite($Handle, $input1.",")>0){echo "<p>First name successfully saved</p>";}
			if(fwrite($Handle, $input2.",")>0){echo "<p>Last name successfully saved</p>";}
			if(fwrite($Handle, $input3.",")>0){echo "<p>E-mail address successfully saved</p>";}
			if(fwrite($Handle, $input4.",")>0){echo "<p>Phone number successfully saved</p>";}
			if(fwrite($Handle, $input5.",")>0){echo "<p>Address successfully saved</p>";}
			if(fwrite($Handle, $input6.",")>0){echo "<p>City successfully saved</p>";}
			if(fwrite($Handle, $input7.",")>0){echo "<p>State successfully saved</p>";}
			if(fwrite($Handle, $input8."\n")>0){echo "<p>Zip code successfully saved</p>";}
		}
		else{
